/**
 *A Standalone Java application capable of Embedding files in images(PNG,BMP,GIF) using a novel and robust technique.
 * @author Clive Jamu Nyandoro
 * @StudentNum N01519173F
 * @SCS4000 Final Year Project
 * @Title File Security using Steganography Compression and Decompression
 * @version 4
...
public class StegoImage {
	...
	public BufferedImage hide(byte[] bytes, int seed) throws Exception {
		...
		if (window == -1)
			throw new IllegalArgumentException("Data size exceeds the payload capacity");
